...
print(oi)
print(f"\x1b[1;31m—{a9}" * 60)
print(" ~ By : @SVVD9 | Channel : https://t.me/S_VD11 ~")
print(f"\x1b[1;31m—{a9}" * 60)
...
def date_sc(Id):
 try:
  if int(Id) >1 and int(Id)<1279000:
   ...
   return "2020-2023"
 except BaseException as princess :
  return princess
...
- Reset : {}
— — — — — — — — — — — — —		
@SVVD9 • https://t.me/S_VD11""".format(name,email,email,followers,following,Id,date,post,rest))
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	sys.stdout.write(f"\r {bo}[ {C} GMAIL {bo}] {C}Good : {F}{good_hot}  {C}Bad IG : {R}{bad_ig}  {C}Good IG : {X}{good_ig}  {C}{bo}Check•{check}\r")
	sys.stdout.flush()
